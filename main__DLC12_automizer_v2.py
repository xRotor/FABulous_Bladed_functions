...
# main script:
for iter_varaible in range(2, 15, 2):  # range(2, 13, 2):
    #DictOfChangeDicts = Bladed().change_dict_for_DLC12_iterations(ref_turbulence_intensity=iter_varaible/100, change_wave_files=False)
    DictOfChangeDicts = Bladed().change_dict_for_DLC12_iterations(wind_shear=iter_varaible/100, change_wave_files=False)
